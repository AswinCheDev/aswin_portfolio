...
export default function GradientCanvas() {
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        uTime: { value: 0 },
        uColor1: { value: new Vec3(0.8, 0.9, 1.0) }, // Soft Light Blue
        uColor2: { value: new Vec3(0.9, 1.0, 0.8) }, // Soft Light Green
        uColor3: { value: new Vec3(1.0, 1.0, 1.0) }, // White
        uColor4: { value: new Vec3(0.85, 0.95, 1.0) }, // Light Cyan
        uColor5: { value: new Vec3(1.0, 1.0, 1.0) }, // White (removes dark spots)
        uNoiseStrength: { value: 0.1 },
        uMode: { value: 0 } // 0 is Mesh Mode
      },
    });
  ...
  return <div ref={containerRef} style={{ width: '100%', height: '100%', position: 'absolute', inset: 0, zIndex: -1 }} />;
}
